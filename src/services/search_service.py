...
def recommend_on_description(db: Session, user_intent: str, limit: int = 3):
        """
        ...
        intent_vector = generate_embedding(user_intent)
...
if __name__ == "__main__":
    ...
    recs = recommend_on_description(db, user_query)
    print(recs)